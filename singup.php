...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <form class="login_form" action="./kernel/reg.php" method="POST" enctype="multipart/form-data">
        <h1 class="login_form-title">account create</h1>

        <div class="login_form-group">
          <input type="text" name="login" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">login</label>
        </div>

        <div class="login_form-group">
          <input type="text" name="full_name" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">name</label>
        </div>

        <div class="login_form-group">
          <input type="email" name = "email" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">email</label>
        </div>
        <div class="login_form-group">
          <input type='file' name='avatar' multiple class="login_form-input" placeholder=" ">
          <label class="login_form-lable">avatar(not *)</label>
        </div>
        <div class="login_form-group">
          <input type="text" name = "address" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">address</label>
        </div>
        <div class="login_form-group">
          <input type="text" name = "number" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">phone number</label>
        </div>
        <div class="login_form-group">
          <input type="password" name="password" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">password</label>
        </div>
        <div class="login_form-group">
          <input type="password" name="password_confirm" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">password confirm</label>
        </div>

        <button class="singup_form-button_singup" type="submit">sing up</button>
 <p>
      Do you already have an account? - <a href="./login.php"><strong> Log in</strong></a>!
        </p>
            <?php
              if($_SESSION['message']){
