...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <form class="login_form" action="./kernel/sign.php" method="POST" enctype="multipart/form-data">
        <h1 class="login_form-title">account login</h1>

        <div class="login_form-group">
          <input type="text" name="login" class="login_form-input" placeholder=" " required>
          <label class="login_form-lable">login or password</label>
        </div>
        ...
        <button class="login_form-button" type = "submit">login</button>
        <!-- <p>or</p>
        <a href="./signup.php"><button class="login_form-button_singup">sing up</button></a> -->
       <p>
      Do you dont have an account? - <a href="./singup.php"><strong>register</strong></a>!
        </p> <?php
