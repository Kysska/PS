    ...
    <div class="wrapper">
              ...
              <li class="menu_catalog">
                ...
                <div class="bg">
                  ...
                  <ul class="sub_catalog-list">
                    ...
                    <li>
                      <a href="#" class="sub_catalog-link">all</a>
                    </li>
                    <li>
      ...
      <div class="help_container">
        ...
        <div class="help_information">
          <div class="help_menu">
            <ul class="help_menu">
              <li class="menu_order"><a href="#order">How to place an order</a></li>
              <li class="menu_order"><a href="#payment">Payment</a></li>
              <li class="menu_order"><a href="#delivery">Delivery</a></li>
              <li class="menu_order"><a href="#refund">Refund</a></li>
              <li class="menu_order"><a href="#contacts">Contacts</a></li>
            </ul>
          </div>
          <div class="help_more-details">
            <div class="details_paragraph" id = "order">
              <div class="details_header">How to place an order</div>
              <div class="details_text">
                ...
                Specify your contact details (Recipient's full name, phone, email, delivery city).
                ...
                The maximum cost of one order is 300,000 rubles when paying on the website and 50,000 rubles when paying by card or cash upon receipt.
                If the cost of your order exceeds the maximum, we recommend placing several orders.<br>
                <br>
                if you have any questions about delivery, please contact customer support:<br>
                <span class="phone_number">8 800 555 35 35</span>
              </div>
            </div>

            
            <div class="details_paragraph">
              <div class="details_header" id="payment">Payment</div>
              <div class="details_text">
                Select the desired product and its quantity, click the "Add to cart" button.
                Go to the "Shopping Cart" section.
                Enter the promo code you have and click the "Place an order" button.
            ...
            <div class="details_paragraph" id="delivery">
              <div class="details_header">Delivery</div>
              <div class="details_text">
                Select the desired product and its quantity, click the "Add to cart" button.
                Go to the "Shopping Cart" section.
                Enter the promo code you have and click the "Place an order" button.
            ...
            <div class="details_paragraph">
              <div class="details_header" id="refund">Refund</div>
              <div class="details_text">
                Select the desired product and its quantity, click the "Add to cart" button.
                Go to the "Shopping Cart" section.
                Enter the promo code you have and click the "Place an order" button.
            ...
            <div class="details_paragraph">
              <div class="details_header" id="contacts">Contacts</div>
              <div class="details_text">
                To contact us, you can use the following methods:<br>
                <br>
                By calling our Customer Support Service by phone: <span class="phone_number">8 800 555 35 35</span> (24/7)
                Write to us by e-mail: clients@petstore.ru
              </div>
            </div>
          </div>
