        ...
        <div class="form-right_content">
          <div class="customer_form_info">
            <form class="customer_form">
              ...
              <a href = "./kernel/red.php" class="customer_form-button_save">editing</a>
              <a href = "./order.php" class="customer_form-button_save">my orders</a>
              <?php
              if($_SESSION['user']['admin'] == '1'){?>

              <a href = "./kernel/admin/product.php" class="customer_form-button_save" style="padding: 9px 83px 0px 105px">Edit the list of products</a>
              <a href = "./kernel/admin/productplus.php" class="customer_form-button_save" style = "padding: 9px 83px 0px 105px">Add a new product</a>
              <a href = "./kernel/admin/order.php" class="customer_form-button_save">List of orders</a>
              <?php }?>
