...
<div class="nav">
  <div class="inner">
    ...
    <div class="wrapper">
      <div class="add_box">
        <div class="header_add">добавление товара в каталог</div>
        <form class="add_box-form"  action = "./productpluslogic.php" method="POST" enctype="multipart/form-data">
          <p><b>категория:</b><br>
          <select name = "cat">
            <option value="fooddog">dog food</option>
            <option value="foodcat">cat food</option>
            <option value="foodroddent">roddents food</option>
            <option value="foodparrot">parrots food</option>
            <option value="foodother">others food</option>
            <option value="beuty">beauty</option>
            <option value="grooming">grooming</option>
            <option value="bowls">bowls</option>
            <option value="clothes">clothes</option>
            <option value="collars">collars and leashes</option>
            <option value="toy">toys</option>
            <option value="bed">beds and carriers</option>
            <option value="cage">cages</option>
          </select>

          </p><p><b>загрузка изображения:</b><br>
            <input type="file" name='avatar' multiple required>

          </p><p><b>название товара:</b><br>
            <input type="text" name="title" placeholder="Введите название:" required>

          </p><p><b>цена товара:</b><br>
            <input type="number" name="price" placeholder="Введите цену:" required>

          </p><p><b>информация о товаре:</b><br>
            <label>описание</label><br>
            <textarea name="desc" cols="40" rows="3" required></textarea><br>
            <label>Вывести товар в каталог: </label>
        <input  type = "radio" class="product-price" name = "check" value="1" ></input> 
           
        </p> <button type = "submit">ДОБАВИТЬ</button></form>
        <?php
              if($_SESSION['message']){
