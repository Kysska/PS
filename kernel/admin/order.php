  ...
  <div class="inner">
      ...
      <li class="menu_catalog">
        ...
        <div class="bg">
          ...
          <ul class="sub_catalog-list">
            ...
            <li>
              <a href="/kernel/feed.php?catid=all" class="sub_catalog-link">all</a>
            </li>
            <li>
    ...
    <div class="line"></div>
          ...
          <div class="bg">
            <div class="forma_icon">
              ...
              <button class="search_button">
                ...
                <circle cx="11.25" cy="11.25" r="10.25" stroke="#1E1E1F" stroke-width="2"></circle>
                <line x1="19.6075" y1="18.1929" x2="27.7075" y2="26.2929" stroke="black" stroke-width="2"></line>
                </svg>
              </button>
            </div>
          </div>
      ...
      <div class="my_orders_container">
        <div class="my_orders_header">my orders</div>
        <div class="my_orders_information">
          <table class="table">
            <tbody>
                <?php
    $prepare = $connect->prepare("SELECT * FROM orders ORDER BY id DESC");
    $prepare->execute();
    $product = $prepare->fetchall(PDO::FETCH_ASSOC); 
    
    foreach($product as $id):
        $check_user = $connect->prepare("SELECT * FROM users WHERE id = ?");
        $check_user->execute([$id['user_id']]);
        $user = $check_user->fetch(PDO::FETCH_ASSOC);
      ?>
              <tr class="order">
                <td class="title">
                  <a href="/kernel/item_card.php?id=<?=$id['product_id']?>" class="title"><?=$id['product']?></a>
                </td>
                <td class="price_one"><?=$id['price']?></td>
                <td class="count"><?=$id['quantity']?></td>
                <td class="price_count"><?=$id['quantity']*$id['price']?></td>
                <td class="price_count"><?=$user['full_name']?></td>
                <td class="price_count"><?=$user['address']?></td>
                <td class="price_count"><?=$user['phone']?></td>
