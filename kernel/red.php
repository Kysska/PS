...
<div class="nav">
  <div class="inner">
    ...
    <div class="line"></div>
      ...
      <div class="customer_full-info">
        <div class="customer_main-info">
          <div class="main_info-left_content">
            <div class="main_info-header">personal data</div>
            <div class="main_info-user">
              <div class="user_icon_box">
  <img src="/<?=$_SESSION['user']['avatar']?>" class="user_icon"
  alt="Avatar" />
              </div>
            
              <div class="user_ns_box">
                <div class="user_name"><?= $_SESSION['user']['full_name']?></div>
                <a href="./kernel/logout.php" class="exit"><div class="exit">exit</div></a>
              </div>
            </div>
          </div>
        </div>
        <div class="form-right_content">
          <div class="customer_form_info">
          <form class="customer_form" action = "./redlogic.php" method="POST" enctype="multipart/form-data">
            <div class="customer_form-group">
            <label class="">avatar</label>
            <input type='file' name='avatar' accept="image/jpeg" />
            </div>
              <div class="customer_form-group">
              <input type="" name="full_name" class="customer_form-input" placeholder=" " value="<?= $_SESSION['user']['full_name']?>" required>
                <label class="customer_form-lable">Name</label>
              </div>
              <div class="customer_form-group">
              <input type="" name="email" class="customer_form-input" placeholder=" " value="<?= $_SESSION['user']['email'] ?> " required>
                <label class="customer_form-lable">email</label>
              </div>
              
              <div class="customer_form-group">
              <input type="" name="login" class="customer_form-input" placeholder=" " value=<?= $_SESSION['user']['login']?> required>
                <label class="customer_form-lable">login</label>
              </div>
              
              <div class="customer_form-group">
              <input type="" name="address" class="customer_form-input" placeholder=" " value="<?= $_SESSION['user']['address']?>" required>
                <label class="customer_form-lable">address</label>
              </div>
              
              <div class="customer_form-group">
              <input type="" name="number" class="customer_form-input" placeholder=" " value="<?= $_SESSION['user']['phone']?>" required>
                <label class="customer_form-lable">phone</label>
              </div>
              <div class="customer_form-group">
              <input type="" name="password" class="customer_form-input" placeholder=" " value="" >
                <label class="customer_form-lable">password</label>
              </div>
              <button type="submit" class="customer_form-button_save">save</button>
              </div>
              <?php
              if($_SESSION['message']){
