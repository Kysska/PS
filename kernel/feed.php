  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="main_picture">
        <div class="main_picture-img" style="background-image: url(/img/main_picture_feed.jpg)"></div>
      </div>
      <div class="container_contents">
        ...
        <div class="content_right" id="content_right">
          ...
          <ul class="categories">
            ...
            <li>
              <a href="./catalog.php?catid=all" class="sub_catalog-link">all products</a>
            </li>
            <li>
              <a href="./feed.php?catid=fooddog" class="sub_catalog-link">for dogs</a>
            </li>
            
            <li>
              <a href="./feed.php?catid=foodcat" class="sub_catalog-link">for cats</a>
            </li>

            <li>
              <a href="./feed.php?catid=foodroddent" class="sub_catalog-link">for rodents</a>
            </li>
            <li>
              <a href="./feed.php?catid=foodparrot" class="sub_catalog-link">for parrots</a>
            </li>

            <li>
              <a href="./feed.php?catid=foodother" class="sub_catalog-link">for others</a>
            </li>
       ...
       ?>
        ...
        <div class="content_left">
          <div class="content_left-item">
            <div class="header_categories"><?=$row1['name']?></div>
            <div class="sort"></div>
            <div class="products">
            <?foreach($row as $item):?>
                <div class="products-item_card">

                  <div class="item_card-labelsale">
                    
                  </div>

                  <a class="item_card-img" href="./item_card.php?id=<?=$item['id']?>"><img class="item_card-img" src="./imageanimals/<?=$item['image']?>"></a>
                  <a class="item_card-details" href="./item_card.php?id=<?=$item['id']?>">
...
<section class="footer">
    ...
    <script type="text/javascript" src="/js/catalog_menu_fix.js"></script>
  </body>
</html>