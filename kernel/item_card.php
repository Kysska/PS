...
<div class="nav">
  <div class="inner">
      ...
      <li class="menu_catalog">
        ...
        <div class="bg">
          ...
          <ul class="sub_catalog-list">
            ...
            <li>
              <a href="./catalog.php?catid=all" class="sub_catalog-link">all</a>
            </li>
            <li>
              <div class="feed_group">
                <div class="feed_hover">

                  <a href="./feed.php?catid=fooddog" class="sub_catalog-link_feed">feed</a>
                  ...
                  <div class="feed_group_links">
                    ...
                    <ul class="sub-sub_catalog-list">
                      ...
                      <div>
                      <li>
                        <a href="./feed.php?catid=fooddog" class="sub-sub_catalog-link">for dogs</a>
                      </li>
                      </div>
                      <div>
                      <li>
                        <a href="./feed.php?catid=foodcat" class="sub-sub_catalog-link">for cats</a>
                      </li>
                      </div>
                      <div>
                      <li>
                        <a href="./feed.php?catid=foodroddent" class="sub-sub_catalog-link">for rodents</a>
                      </li>
                      </div>
                      <div>
                      <li>
                        <a href="./feed.php?catid=foodparrot" class="sub-sub_catalog-link">for parrots</a>
                      </li>
                      </div>
                      <div>
                      <li>
                        <a href="./feed.php?catid=foodother" class="sub-sub_catalog-link">for others</a>
                      </li>
                      </div>
                      </div>
                    </ul>
            ...
            <li>
              <a href="./catalog.php?catid=beuty" class="sub_catalog-link">beauty</a>
            </li>
            <li>
              <a href="./catalog.php?catid=grooming" class="sub_catalog-link">grooming</a>
            </li>
            <li>
              <a href="./catalog.php?catid=bowls" class="sub_catalog-link">bowls</a>
            </li>
            <li>
              <a href=" ./catalog.php?catid=clothes" class="sub_catalog-link">clothes</a>
            </li>
            <li>
              <a href="./catalog.php?catid=collars" class="sub_catalog-link">collars and leashes</a>
            </li>
            <li>
              <a href="./catalog.php?catid=toy" class="sub_catalog-link">toys</a>
            </li>
            <li>
              <a href="./catalog.php?catid=bed" class="sub_catalog-link">beds and carriers</a>
            </li>
            <li>
              <a href="./catalog.php?catid=cage" class="sub_catalog-link">cages</a>
            </li>
      ...
      <div class="conteiner_card">
        ...
        <div class="product_main-info">
          <div class="product_card">
            <div class="image"><img class="image" src="./imageanimals/<?=$row['image']?>"></div>
            <div class="main-info">
              <div class="type">TYPE OF PRODUCT</div>
                <div class="full_name">
                  <a class="brand" href="#"><?=$row['title']?></a>
                </div>
              <div>
              ...
              <div class="article">
                <div class="article_num">ARTICLE NUMBER:</div>
                <div class="a_number">000000</div>
              </div>
              <div class="price"><?=$row['price']?></div>
              <div class="buttons">
                <div class="calc">
                  <span class="decrement">-</span>
                  <input type="number" name="calc" class="number" value="1" min="1" max="99">
                  <span class="increment">+</span>
                </div>
                <div class="messadge_add_to_cart"  class="messadge_add_to_cart" id="messadge_add_to_cart">Товар добавлен в корзину!</div>
                <div class="add_button_with_icon" id="add_button">
                  <button class="add_to_cart" id = "<?=$row['id']?>">ADD TO CART</button>
                </div>
              </div>
              <div class="items_price-info">The price is valid only for the online store and may differ from the prices in retail stores</div>
            </div>
          </div>
        </div>


        <div class="product_about-info">

          <div class="over_info">
            <div class="customer_support-ser">
              <div class="customer_support-icon">
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="37" height="31" rx="5" fill="#1E1E1F"/>
                <path d="M28 38L19.3397 26.75L36.6603 26.75L28 38Z" fill="#1E1E1F"/>
              ...
              <div class="customer_support-info">
                <div class="need_help">need help?</div>
                <div>
                  <a class="customer_support_click" href="#">customer support service</a>
                </div>
              </div>
            </div>
            ...
            <div class="advantages">
              <ul>
                ...
                <li>
                  delivery throughout Europe and the USA
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="about_info">
            <div class="headers_about-info">
              <div class="about pointer"  id ="about">about</div>
              <div class="application pointer"  id ="application">application</div>
              <div class="structure pointer"  id ="structure">structure</div>
            </div>
            <div class="line"></div>
            <div class="about_info-text">
              <div class="full_name">
                <div class="brand">BRAND</div>
                <div class="name">name of products</div>
              </div>
              <div class="text_about">
                <p class="text_about" id = "text_about">
                  The BAKSTER AND CAT collar is a perfectly convenient accessory for your pet. The genuine leather from which the collar is made is completely safe for the tail, and the manually processed edges are not rubbed in the neck area.
                  <br>
                  <br>
                  The collar in the NORTHERN LIGHTS color is a combination of two layers of skin. The outer layer is made of smooth dense dark blue leather, the inner layer is made of textured neon green leather. BAKSTER AND CAT uses only high-quality leather, thanks to which the collar has become a durable accessory. The metal buckle helps to securely fix the worn collar, preventing stretching at the most unfortunate moment. The half-ring serves not only to secure the leash, but also fixes the end of the collar.
                  <br>
                  <br>
                  The width of the collar is 2.5 cm.
                  Size S – neck circumference from 21 to 31 cm.
                  Size M – neck circumference from 28 to 38 cm.
                  Size L – neck circumference from 36 to 46
                </p>

                <p class="text_application" id = "text_application">
                 The BAKSTER AND CAT collar is a perfectly convenient accessory for your pet.
                 <br>
                  The genuine leather from which the collar is made is completely safe for the tail, and the manually processed edges are not rubbed in the neck area.
                </p>

                <p class="text_structure" id = "text_structure">
                  <br>
                  The width of the collar is 2.5 cm. <br>
                  Size S – neck circumference from 21 to 31 cm.<br>
                  Size M – neck circumference from 28 to 38 cm.<br>
                  Size L – neck circumference from 36 to 46
                </p>
      ...
      <section class="footer">
          ...
          <div class="footer_menu">
            <div class="left_menu">
              ...
              <a href="./catalog.php?catid=all"><div>shops</div></a>
    ...
    <script type="text/javascript" src="/js/item_card_switch.js"></script>
    <script>
  var col = 1;    
  ...
  if (e.target.classList.contains("increment")) {
   ...
   $('.number').change(function () {    
    ...
    $('.add_to_cart').click(function () {//клип на кнопку
        var id = $(this).attr('id');
            $.ajax({//передаем ajax-запросом данные
            type: "POST", //метод передачи данных
            url: './cart_f.php',//php-файл для обработки данных
            data: {id_tov: id, col_tov: col},//передаем наши данные
