    ...
    <div class="line"></div>
      ...
      <div class="about_container">
        ...
        <div class="about_information">
          <div class="about_information-texts">
            <div class="about_inf_pet_store">PET STORE - <br>online store of pet products</div>
            <div class="about_inf_text">All pets — from a small fish to a giant dog — need affection, care and attention. Whoever is in your care — a tiny creature or a big, serious beast — the PET STORE will help you take care of him.<br> 
            <br>
            With the help of our products, make the life of your beloved animal long, happy and bright
            </div>
          ...
          <div class="about_img"><img src="img/about_img.jpg" class="about_img"> </div>
