  ...
  <body>
    <div class="wrapper">
      ...
      <div class="content">
          ...
          <div class="container">
            <div class="slider_inner">
              ...
              <div class="slider_item">
                <div class="slider_item-img" style="background-image: url(img/slider-1.png)"></div>
                <div class="slide_item-info">
                  <div class="slider_subtitle">-20%</div>
                  <div class="slider_title">brushes and fluffers</div>
                  <div class="slider_text">only until january 8th</div>
                  <a class="slider_btn" href="./sale.php" >MORE</a>
                </div>
              ...
              <div class="slider_item">
                <div class="slider_item-img" style="background-image: url(img/slider-2.png)"></div>
                <div class="slide_item-info">
                  <div class="slider_title">Wild One</div>
                  <div class="slider_text">accessories and toys for dogs</div>
                  <a class="slider_btn" href="./sale.php">MORE</a>
                </div>
              ...
              <div class="slider_item">
                <div class="slider_item-img" style="background-image: url(img/slider-3.png)"></div>
                <div class="slide_item-info">
                  <div class="slider_subtitle">-15%</div>
                  <div class="slider_title">beds</div>
                  <div class="slider_text">only from december 15th to january 2nd</div>
                  <a class="slider_btn" href="./sale.php">MORE</a>
                </div>
        ...
        <div class="fast_click_categories">
        <a href="./kernel/catalog.php?catid=fooddog">
          <button class="categories_link_d" >
            <span class="icon">
              <img src="img/dog_fastclick.svg">
            </span>
          </button>
        </a>
        <a href="./kernel/catalog.php?catid=foodcat">
          <button class="categories_link_c" >
            <span class="icon">
              <img src="img/cat_fastclick.svg">
            </span>
          </button>
        </a>
        <a href="./kernel/catalog.php?catid=foodroddent">
          <button class="categories_link_r" >
            <span class="icon">
              <img src="img/roddents_fastclick.svg">
            </span>
          </button>
        </a>
        <a href="./kernel/catalog.php?catid=foodparrot">
          <button class="categories_link_p" >
            <span class="icon">
              <img src="img/parrot_fastclick.svg">
            </span>
          </button>
        </a>
        <a href="./kernel/catalog.php?catid=foodother">
          <button class="categories_link_f" >
            <span class="icon">
              <img src="img/fish_fastclick.svg">

            </span>
          </button>
        </a>
        <a href="./kernel/catalog.php?catid=foodother">
          <button class="categories_link_re" >
            <span class="icon">
              <img src="img/reptitle_fastclick.svg">
            </span>
          </button>
        </a>
        </div>
        <?php
       $prepare = $connect->prepare("SELECT * FROM products WHERE `tobe` = 1 ORDER BY 'id' DESC LIMIT 5");
       $prepare->execute();
       $row = $prepare->fetchAll();
       ?>

        <section class="news">
          <div class="header_news"> <a href="">new! products</a> </div>
          <div class="new_products">
          <?foreach($row as $item):?>
            <div class="new_products-item_card">

              <div class="item_card-labelsale">
                
              </div>
              
              <a class="item_card-img" href="./kernel/item_card.php?id=<?=$item['id']?>"><img src="./kernel/imageanimals/<?=$item['image']?>"></a>
              <a class="item_card-details"href="./kernel/item_card.php?id=<?=$item['id']?>">
                <div class="item_card_details-type">SMART FEEDER FOR PETS</div>
                <div class="item_card_details-full_name">
                  <span class="item_card-brand"><?=$item['title']?></span>
                </div>
                <div>
                  <span class="item_card-name">smart pet food feeder</span>
                </div>
        ...
        <section class="sales">
          <div class="header_news"> <a href="./sale.php">stocks! sale</a> </div>
          <div class="sales_item">

            <div class="sales_item-cards">
              <div class="item_card-date">
                
              </div>
              <a class="sales_card-details pointer" href="#">
                <div class="item_card-content_1" style="background-image: url(img/ters_of_use.png)">
                  
                    <div class="slider_title">terms of delivery</div>
            ...
            <div class="sales_item-cards">
              <div class="item_card-date">
                <div class="first_line">december 15 -</div>
                <div class="second_line">january 10</div>
              </div>
              
                <div class="item_card-content_2" style="background-image: url(img/first_order_sale.png)">
                  <div class="slider_list">
                    <div class="slider_subtitle">-10%</div>
                    <div class="slider_title">for the first order</div>
                  </div>
                </div>
            ...
            <div class="sales_item-cards">
              <div class="item_card-date">
                <div class="first_line">december 15 -</div>
                <div class="second_line">december 18</div>
              </div>
              
                <div class="item_card-content_3" style="background-image: url(img/free_gift_sale.png)">
                  <div class="slider_list">
                    <div class="slider_subtitle">free gift</div>
                    <div class="slider_title">for the first order</div>
                    <div class="slider_text">only for the first order</div>
                  </div>
                </div>
        ...
        <section class="forma">
          <div class="forma_space">
            <div class="personal_offers">
                <div class="offer_text">personal offers</div>
            </div>
            <div class="forma_space-border">
              
              <div class="forma_content-left">
                <div class="forma_subtitle">subscribe to the newsletter</div>
                <div class="forma_text">our e-mail: marketing@petstore.ru - marketing department, for marketing activity and advertising</div>
              </div>

              <div class="forma_content-right">
                <div class="email">e-mail</div>
                <div class="form">
                  <input type="text" class="text_email">
                  <div class="form_line"></div>
                </div>
                <div class="metca">
                  <input type="checkbox" name="">
                  <div class="metca_text">I agree with the <a class="pp" style="text-decoration: underline;">privacy policy</a></div>
                </div>
                <div class="form_btn">
